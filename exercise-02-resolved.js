...
const context = `Tu eres un contador experto.`;
const question = `Podrias sacar los taxes del siguiente documento en un objeto json: ${invoice}`;
const question2 = `Necesito que saques el valor total de los impuestos y el valor total de la factura y lo formatees en un objeto json`;
